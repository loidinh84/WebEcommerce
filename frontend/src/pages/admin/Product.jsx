...
const mockProductsData = [
  {
    ...
    bien_the: [{ sku: "IP16-256-TITAN", mau_sac: "Titan Đen", dung_luong: "256GB", ram: "8GB", gia_ban: 34990000, gia_goc: 30000000, ton_kho: 50, ma_mau_hex: "#2C2C2C", trang_thai: "active" }],
    thuoc_tinh: [{ ten_thuoc_tinh: "Màn hình", gia_tri: "6.9 inch OLED", nhom: "Màn hình", thu_tu: 1 }, { ten_thuoc_tinh: "Chip", gia_tri: "Apple A18 Pro", nhom: "Hiệu năng", thu_tu: 2 }],
    hinh_anh: [],
    trang_thai: "active", noi_bat: true, mo_ta_ngan: "Flagship Apple mới nhất 2025, chip A18 Pro.",
    mo_ta_day_du: "iPhone 16 Pro Max là flagship cao cấp nhất của Apple năm 2025.",
    created_at: "2025-01-10T00:00:00.000Z",
  },
  {
    id: "SP002", ten_san_pham: "iPhone 15 128GB", thuong_hieu: "Apple",
    supplier: "Apple Vietnam", category: "Điện thoại di động",
    bien_the: [{ sku: "IP15-128-PINK", mau_sac: "Hồng", dung_luong: "128GB", ram: "6GB", gia_ban: 19990000, gia_goc: 17000000, ton_kho: 0, ma_mau_hex: "#FFB6C1", trang_thai: "active" }],
    thuoc_tinh: [{ ten_thuoc_tinh: "Màn hình", gia_tri: "6.1 inch OLED", nhom: "Màn hình", thu_tu: 1 }],
    hinh_anh: [],
    trang_thai: "active", noi_bat: false, mo_ta_ngan: "iPhone 15 tiêu chuẩn, camera 48MP.",
    mo_ta_day_du: "", created_at: "2025-02-01T00:00:00.000Z",
  },
  {
    id: "SP003", ten_san_pham: "Samsung Galaxy S24 Ultra", thuong_hieu: "Samsung",
    supplier: "Samsung Vietnam", category: "Điện thoại di động",
    bien_the: [{ sku: "S24U-256-BLK", mau_sac: "Đen", dung_luong: "256GB", ram: "12GB", gia_ban: 27490000, gia_goc: 24000000, ton_kho: 20, ma_mau_hex: "#1a1a1a", trang_thai: "active" }],
    thuoc_tinh: [{ ten_thuoc_tinh: "Bút S Pen", gia_tri: "Tích hợp", nhom: "Tính năng", thu_tu: 1 }],
    hinh_anh: [],
    trang_thai: "active", noi_bat: true, mo_ta_ngan: "Flagship Samsung, bút S Pen tích hợp.",
    mo_ta_day_du: "", created_at: "2025-02-15T00:00:00.000Z",
  },
  {
    id: "SP004", ten_san_pham: "MacBook Air M3 13 inch", thuong_hieu: "Apple",
    supplier: "Apple Vietnam", category: "Laptop & Macbook",
    bien_the: [{ sku: "MBA-M3-256", mau_sac: "Xám", dung_luong: "256GB", ram: "8GB", gia_ban: 27990000, gia_goc: 25000000, ton_kho: 15, ma_mau_hex: "#9EA3A8", trang_thai: "active" }],
    thuoc_tinh: [{ ten_thuoc_tinh: "Chip", gia_tri: "Apple M3", nhom: "Hiệu năng", thu_tu: 1 }],
    hinh_anh: [],
    trang_thai: "active", noi_bat: true, mo_ta_ngan: "Laptop siêu mỏng nhẹ, chip M3 mạnh mẽ.",
    mo_ta_day_du: "", created_at: "2025-03-01T00:00:00.000Z",
  },
  {
    id: "SP005", ten_san_pham: "Laptop ASUS ROG Strix G15", thuong_hieu: "ASUS",
    supplier: "ASUS Global", category: "Laptop & Macbook",
    bien_the: [
      { sku: "ROG-G15-512", mau_sac: "Xám Eclipse", dung_luong: "512GB", ram: "16GB", gia_ban: 32990000, gia_goc: 30000000, ton_kho: 5, ma_mau_hex: "#3D3D3D", trang_thai: "active" },
      { sku: "ROG-G15-1TB", mau_sac: "Xám Eclipse", dung_luong: "1TB", ram: "32GB", gia_ban: 38990000, gia_goc: 35000000, ton_kho: 3, ma_mau_hex: "#3D3D3D", trang_thai: "active" },
    ],
    thuoc_tinh: [{ ten_thuoc_tinh: "GPU", gia_tri: "NVIDIA RTX 4070", nhom: "Hiệu năng", thu_tu: 1 }],
    hinh_anh: [],
    trang_thai: "active", noi_bat: false, mo_ta_ngan: "Gaming laptop cao cấp, RTX 4070.",
    mo_ta_day_du: "", created_at: "2025-03-10T00:00:00.000Z",
  },
  {
    id: "SP006", ten_san_pham: "Laptop ASUS TUF Gaming F15", thuong_hieu: "ASUS",
    supplier: "ASUS Global", category: "Laptop & Macbook",
    bien_the: [{ sku: "TUF-F15-512", mau_sac: "Đen", dung_luong: "512GB", ram: "16GB", gia_ban: 22000000, gia_goc: 20000000, ton_kho: 10, ma_mau_hex: "#111111", trang_thai: "active" }],
    thuoc_tinh: [],
    hinh_anh: [],
    trang_thai: "inactive", noi_bat: false, mo_ta_ngan: "Laptop gaming quốc dân, cấu hình cực mạnh.",
    mo_ta_day_du: "", created_at: "2025-03-20T00:00:00.000Z",
  },
  {
    id: "SP007", ten_san_pham: "Bàn phím cơ AKKO 3098B", thuong_hieu: "AKKO",
    supplier: "GearVN", category: "Phụ kiện - Bàn phím",
    bien_the: [{ sku: "AK-3098B-HONG", mau_sac: "Hồng", dung_luong: "", ram: "", gia_ban: 1500000, gia_goc: 1200000, ton_kho: 15, ma_mau_hex: "#FF69B4", trang_thai: "active" }],
    thuoc_tinh: [{ ten_thuoc_tinh: "Switch", gia_tri: "Jelly Pink", nhom: "Phím", thu_tu: 1 }],
    hinh_anh: [],
    trang_thai: "active", noi_bat: false, mo_ta_ngan: "Phím cơ giá sinh viên, switch Jelly Pink.",
    mo_ta_day_du: "", created_at: "2025-04-01T00:00:00.000Z",
  },
];
...
const Product = () => {
  ...
  const emptyFormData = {
    ...
    trang_thai: "active", mo_ta_ngan: "", mo_ta_day_du: "", noi_bat: false,
    thuoc_tinh: [{ ten_thuoc_tinh: "", gia_tri: "", nhom: "", thu_tu: 1 }],
    bien_the:   [{ sku: "", mau_sac: "", dung_luong: "", ram: "", gia_goc: 0, gia_ban: 0, ton_kho: 0, ma_mau_hex: "", trang_thai: "active" }],
    hinh_anh:   [],
  };
  ...
  const countTab = (tab) => {
    ...
    if (tab === "active")       return products.filter(p => p.status === "active").length;
    if (tab === "inactive")     return products.filter(p => p.status === "inactive").length;
    if (tab === "out_of_stock") return products.filter(p => p.stock === 0).length;
    if (tab === "featured")     return products.filter(p => p.isFeatured).length;
    return 0;
  };
  const countByCategory = (cat) => cat === "all" ? products.length : products.filter(p => p.category === cat).length;
  const countBySupplier = (sup) => sup === "all" ? products.length : products.filter(p => p.supplier === sup).length;
  const countByStatus   = (s)   => s   === "all" ? products.length : products.filter(p => p.status === s).length;
  ...
  const hasActiveFilter = selectedCategory !== "all" || selectedSupplier !== "all" ||
  ...
  const removeRow = (n, index) => setFormData(prev => ({ ...prev, [n]: prev[n].filter((_, i) => i !== index) }));
  ...
  const handleSaveProduct = async () => {
    ...
    try {
      if (editingProduct) {
        await axios.put(`${API_BASE}/api/sanpham/${editingProduct.id}`, dataToSend, config);
      ...
      const saved = {
        ...
        supplier:   suppliers.find(s => String(s.id) === String(formData.nha_cung_cap_id))?.name || "Chưa cập nhật",
        category:   categories.find(c => String(c.id) === String(formData.danh_muc_id))?.name || "Chưa cập nhật",
      ...
      <div className="flex w-full max-w-[1536px] h-full p-4 lg:p-6 gap-4 lg:gap-6">
        ...
        <div className="w-64 shrink-0 flex flex-col gap-4 overflow-y-auto hide-scrollbar pb-4 pr-1">
          ...
          <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-200">
            ...
            <input
              type="text" placeholder="Tên, thương hiệu..."
          ...
          <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-200">
            <div className="flex justify-between items-center mb-3">
              ...
              <button onClick={() => setIsAddCategoryOpen(true)} className="text-gray-400 hover:text-blue-600 text-xl cursor-pointer font-medium leading-none" title="Thêm danh mục">+</button>
            </div>
            <div className="space-y-0.5 text-sm">
              {[{ value: "all", label: "Tất cả" }, ...categories.map(c => ({ value: c.name, label: c.name }))].map(item => (
                <button key={item.value} onClick={() => setSelectedCategory(item.value)}
                ...
                >
                  ...
                  <span className="text-xs px-1.5 py-0.5 rounded-full bg-gray-100 text-gray-500 shrink-0 ml-1">{countByCategory(item.value)}</span>
                </button>
              ))}
            </div>
          </div>
          ...
          <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-200">
            <div className="flex justify-between items-center mb-3">
              ...
              <button onClick={() => setIsAddSupplierOpen(true)} className="text-gray-400 hover:text-blue-600 text-xl cursor-pointer font-medium leading-none" title="Thêm nhà cung cấp">+</button>
            </div>
            <div className="space-y-0.5 text-sm">
              {[{ value: "all", label: "Tất cả" }, ...suppliers.map(s => ({ value: s.name, label: s.name }))].map(item => (
                <button key={item.value} onClick={() => setSelectedSupplier(item.value)}
                  className={`w-full flex justify-between items-center px-3 py-2 rounded-lg transition-colors text-left cursor-pointer font-medium
                    ${selectedSupplier === item.value ? "bg-gray-100 text-gray-900 font-bold" : "text-gray-600 hover:bg-gray-50"}`}
                >
                  <span className="truncate">{item.label}</span>
                  <span className="text-xs px-1.5 py-0.5 rounded-full bg-gray-100 text-gray-500 shrink-0 ml-1">{countBySupplier(item.value)}</span>
                </button>
              ))}
            </div>
          </div>
          ...
          <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-200">
            ...
            <div className="space-y-0.5 text-sm">
              {[
                ...
                <button key={item.value} onClick={() => setStockFilter(item.value)}
                  className={`w-full flex justify-between items-center px-3 py-2 rounded-lg transition-colors text-left cursor-pointer font-medium
                    ${stockFilter === item.value ? "bg-gray-100 text-gray-900 font-bold" : "text-gray-600 hover:bg-gray-50"}`}
                >
                  <span>{item.label}</span>
                  <span className="text-xs px-1.5 py-0.5 rounded-full bg-gray-100 text-gray-500">{countByStock(item.value)}</span>
                </button>
              ))}
            </div>
          </div>
          ...
          <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-200">
            ...
            <div className="space-y-2 text-sm">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-bold text-gray-800">{countByStatus("active")}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-500">Ngừng kinh doanh</span>
                <span className="font-bold text-gray-800">{countByStatus("inactive")}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-500">Hết hàng</span>
                <span className="font-bold text-red-500">{countByStock("out_of_stock")}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-500">Sản phẩm nổi bật</span>
                <span className="font-bold text-yellow-600">{countTab("featured")}</span>
              </div>
              ...
              <div className="border-t border-gray-100 pt-2 mt-1">
                ...
                <p className="text-xs font-bold text-gray-500 uppercase tracking-wide mb-2">Bán chạy nhất</p>
                {[...products]
                  ...
                  .map((p, i) => (
                    <div key={p.id} className="flex justify-between items-center py-1">
                      ...
                      <span className="text-xs font-bold text-blue-600 shrink-0 ml-1">{(p.luot_mua || 0).toLocaleString()}</span>
                    </div>
                  ))}
                {products.filter(p => (p.luot_mua || 0) > 0).length === 0 && (
                  <p className="text-xs text-gray-400 italic">Chưa có dữ liệu lượt mua.</p>
                )}
              </div>

              {/* Giá trị cao nhất */}
              <div className="border-t border-gray-100 pt-2">
                <p className="text-xs font-bold text-gray-500 uppercase tracking-wide mb-2">Giá trị cao nhất</p>
                {[...products]
                  ...
                  .map((p, i) => (
                    <div key={p.id} className="flex justify-between items-center py-1">
                      ...
                      <span className="text-xs font-bold text-purple-600 shrink-0 ml-1">
                        {new Intl.NumberFormat("vi-VN", { notation: "compact", maximumFractionDigits: 1 }).format(p.price)}đ
                      </span>
                    </div>
                  ))}
          ...
          <div className="px-6 py-5 flex justify-between items-center border-b border-gray-100 bg-white shrink-0">
            ...
            <button
              onClick={() => {
                ...
                setEditingProduct(null); setFormData({ ...emptyFormData }); setUploadedFiles([]);
              }}
          ...
          <div className="flex-1 overflow-auto bg-gray-50/30 relative">
            <table className="w-full text-left border-collapse min-w-max">
              <thead className="sticky top-0 bg-gray-50 text-gray-600 z-10 text-sm">
                <tr>
                  <th className="py-3 px-5 font-bold border-b border-gray-200">Mã & Tên sản phẩm</th>
                  <th className="py-3 px-5 font-bold border-b border-gray-200">Danh mục</th>
                  <th className="py-3 px-5 font-bold border-b border-gray-200">Nhà cung cấp</th>
                  <th className="py-3 px-5 font-bold border-b border-gray-200 text-right">Giá bán</th>
                  <th className="py-3 px-5 font-bold border-b border-gray-200 text-center w-24">Tồn kho</th>
                  <th className="py-3 px-5 font-bold border-b border-gray-200 text-center w-36">Trạng thái</th>
                </tr>
              </thead>
              <tbody className="text-sm text-gray-700">
                {isLoading ? (
                  ...
                  <tr><td colSpan="6" className="py-10 text-center text-gray-500 font-medium">Không tìm thấy sản phẩm nào.</td></tr>
                ) : (
                        ...
                        >
                          <td className="py-3 px-5">
                            <div className="font-semibold text-gray-900 flex items-center gap-2">
                              {p.name}
                              {p.isFeatured && (
                                <span className="bg-yellow-100 text-yellow-700 text-[10px] px-2 py-0.5 rounded border border-yellow-300 font-bold whitespace-nowrap">Nổi bật</span>
                              )}
                            </div>
                            <div className="text-xs text-gray-400 mt-0.5">Mã: {p.id} · {p.brand}</div>
                          </td>
                          <td className="py-3 px-5 text-gray-600 text-sm">{p.category}</td>
                          <td className="py-3 px-5 text-gray-600 text-sm">{p.supplier}</td>
                          <td className="py-3 px-5 text-right font-bold text-gray-800">{formatPrice(p.price)}</td>
                          ...
                          <td className="py-3 px-5 text-center">
                            {p.status === "active" ? (
                              <span className="bg-green-100 text-green-700 border border-green-200 px-3 py-1 rounded text-xs font-bold uppercase whitespace-nowrap">Đang KD</span>
                            ) : (
                              <span className="bg-red-100 text-red-500 border border-red-200 px-3 py-1 rounded text-xs font-bold uppercase whitespace-nowrap">Ngừng bán</span>
                            )}
                          </td>
                        </tr>
                            ...
                            <td colSpan="6" className="p-0 whitespace-normal">
                              ...
                              <div className="flex border-b border-gray-200 px-6 pt-2 bg-gray-50 gap-1">
                                {[
                                  ...
                                  { key: "variants",   label: `Biến thể (${p.variants.length})` },
                                  { key: "attributes", label: `Thuộc tính (${p.attributes.length})` },
                                  { key: "images",     label: `Hình ảnh (${p.images.length})` },
                                ].map(tab => (
                                  <button key={tab.key}
                                    onClick={() => setActiveDetailTab(prev => ({ ...prev, [p.id]: tab.key }))}
                              ...
                              <div className="p-5">
                                ...
                                {currentDetailTab === "info" && (
                                  <div className="flex flex-col xl:flex-row gap-5">
                                    ...
                                    <div className="flex-1 bg-white rounded-lg border border-gray-200 p-5">
                                      <h4 className="font-bold text-gray-700 text-xs uppercase tracking-wider mb-4 border-b pb-2">Thông tin cơ bản</h4>
                                      <div className="grid grid-cols-2 gap-x-6 gap-y-3 text-sm">
                                        <div>
                                          <p className="text-gray-500 text-xs mb-0.5">Tên sản phẩm</p>
                                          <p className="font-semibold text-gray-900">{p.name}</p>
                                        </div>
                                        <div>
                                          <p className="text-gray-500 text-xs mb-0.5">Thương hiệu</p>
                                          <p className="font-semibold text-gray-900">{p.brand || "—"}</p>
                                        </div>
                                        <div>
                                          <p className="text-gray-500 text-xs mb-0.5">Danh mục</p>
                                          <p className="font-semibold text-gray-900">{p.category}</p>
                                        </div>
                                        <div>
                                        ...
                                        <div>
                                          <p className="text-gray-500 text-xs mb-0.5">Giá gốc (nhập)</p>
                                          <p className="font-semibold text-gray-900">{formatPrice(p.cost)} ₫</p>
                                        </div>
                                        <div>
                                          <p className="text-gray-500 text-xs mb-0.5">Giá bán</p>
                                          <p className="font-bold text-blue-600">{formatPrice(p.price)} ₫</p>
                                        </div>
                                        <div>
                                          <p className="text-gray-500 text-xs mb-0.5">Tổng tồn kho</p>
                                          <p className={`font-bold ${p.stock === 0 ? "text-red-500" : "text-gray-900"}`}>{p.stock === 0 ? "Hết hàng" : `${p.stock} sản phẩm`}</p>
                                        </div>
                                        <div>
                                          <p className="text-gray-500 text-xs mb-0.5">Nổi bật</p>
                                          <p className="font-semibold text-gray-900">{p.isFeatured ? "✓ Có" : "Không"}</p>
                                        </div>
                                        <div className="col-span-2">
                                          <p className="text-gray-500 text-xs mb-0.5">Mô tả ngắn</p>
                                          <p className="text-gray-700">{p.shortDesc || <span className="italic text-gray-400">Chưa có mô tả</span>}</p>
                                        </div>
                                        {p.fullDesc && (
                                          <div className="col-span-2">
                                            <p className="text-gray-500 text-xs mb-0.5">Mô tả đầy đủ</p>
                                            <p className="text-gray-700 text-xs leading-relaxed line-clamp-3">{p.fullDesc}</p>
                                          </div>
                                        )}
                                      </div>
                                    </div>
                                    ...
                                    <div className="w-full xl:w-44 shrink-0 flex flex-col gap-2.5">
                                      <h4 className="font-bold text-gray-700 text-xs uppercase tracking-wider mb-1 border-b pb-2">Thao tác</h4>
                                ...
                                {currentDetailTab === "variants" && (
                                  <div>
                                    {p.variants.length === 0 ? (
                                      <p className="text-gray-500 italic text-sm text-center py-6">Chưa có biến thể nào.</p>
                                    ) : (
                                      <div className="overflow-x-auto">
                                        <table className="w-full text-left text-sm border rounded-lg overflow-hidden min-w-max">
                                          <thead className="bg-gray-100">
                                            <tr>
                                              <th className="p-3 font-bold text-gray-700">SKU</th>
                                              <th className="p-3 font-bold text-gray-700">Màu sắc</th>
                                              <th className="p-3 font-bold text-gray-700">Dung lượng</th>
                                              <th className="p-3 font-bold text-gray-700">RAM</th>
                                              <th className="p-3 font-bold text-gray-700 text-right">Giá gốc</th>
                                              <th className="p-3 font-bold text-gray-700 text-right">Giá bán</th>
                                              <th className="p-3 font-bold text-gray-700 text-center">Tồn kho</th>
                                              <th className="p-3 font-bold text-gray-700 text-center">Trạng thái</th>
                                            </tr>
                                          </thead>
                                          <tbody>
                                            {p.variants.map((v, idx) => (
                                              <tr key={idx} className="border-t bg-white hover:bg-gray-50">
                                                <td className="p-3 font-mono text-xs font-semibold text-gray-700">{v.sku || "—"}</td>
                                                <td className="p-3">
                                                  <div className="flex items-center gap-2">
                                                    {v.ma_mau_hex && (
                                                      <span className="w-4 h-4 rounded-full border border-gray-300 shrink-0" style={{ backgroundColor: v.ma_mau_hex }} />
                                                    )}
                                                    <span>{v.mau_sac || "—"}</span>
                                                  </div>
                                                </td>
                                                <td className="p-3">{v.dung_luong || "—"}</td>
                                                <td className="p-3">{v.ram || "—"}</td>
                                                <td className="p-3 text-right text-gray-600">{formatPrice(v.gia_goc)} ₫</td>
                                                <td className="p-3 text-right font-bold text-blue-600">{formatPrice(v.gia_ban)} ₫</td>
                                                <td className="p-3 text-center font-bold">
                                                  {Number(v.ton_kho) === 0
                                                    ? <span className="text-red-500">Hết</span>
                                                    : <span className="text-gray-800">{v.ton_kho}</span>}
                                                </td>
                                                <td className="p-3 text-center">
                                                  <span className={`text-xs font-bold px-2 py-0.5 rounded ${v.trang_thai === "active" ? "bg-green-100 text-green-700" : "bg-gray-100 text-gray-500"}`}>
                                                    {v.trang_thai === "active" ? "Hiện" : "Ẩn"}
                                                  </span>
                                                </td>
                                              </tr>
                                            ))}
                                ...
                                {currentDetailTab === "attributes" && (
                                  <div>
                                    {p.attributes.length === 0 ? (
                                      <p className="text-gray-500 italic text-sm text-center py-6">Chưa có thuộc tính nào.</p>
                                    ) : (
                                        ...
                                        {p.attributes
                                          ...
                                          .map((attr, idx) => (
                                            <div key={idx} className="bg-white border border-gray-200 rounded-lg p-3 flex justify-between items-center">
                                              <span className="text-gray-500 text-xs font-semibold">{attr.nhom ? `[${attr.nhom}] ` : ""}{attr.ten_thuoc_tinh}</span>
                                              <span className="font-bold text-gray-800 text-sm text-right ml-3">{attr.gia_tri}</span>
                                            </div>
                                          ))}
                                      </div>
                                    )}
                                ...
                                {currentDetailTab === "images" && (
                                  <div>
                                    {p.images.length === 0 ? (
                                      <p className="text-gray-500 italic text-sm text-center py-6">Chưa có hình ảnh nào.</p>
                                    ) : (
                                      <div className="grid grid-cols-3 md:grid-cols-5 xl:grid-cols-6 gap-3">
                                        {p.images
                                          .sort((a, b) => (a.thu_tu || 0) - (b.thu_tu || 0))
                                          .map((img, idx) => (
                                            <div key={idx} className={`relative rounded-lg overflow-hidden border-2 ${img.la_anh_chinh ? "border-blue-500" : "border-gray-200"}`}>
                                              <img
                                              ...
                                              />
                                              {img.la_anh_chinh && (
                                                <span className="absolute top-0 left-0 bg-blue-500 text-white text-[9px] px-1.5 py-0.5 font-bold">Chính</span>
                                              )}
                                            </div>
                                          ))}
                                      </div>
        ...
        <div className="fixed inset-0 z-[200] flex items-center justify-center bg-gray-900/60 backdrop-blur-sm p-4">
          <div className="bg-white w-full max-w-sm rounded-2xl shadow-2xl overflow-hidden">
            <div className="px-6 py-4 border-b flex justify-between items-center bg-gray-50">
              ...
              <button onClick={() => setIsAddCategoryOpen(false)} className="text-2xl cursor-pointer hover:text-red-500 leading-none">&times;</button>
            </div>
            <form onSubmit={handleQuickSaveCategory}>
              <div className="p-6">
                <input type="text" value={newCategoryName} onChange={(e) => setNewCategoryName(e.target.value)}
                  className="w-full p-3 border rounded-xl outline-none focus:border-blue-500 font-medium" placeholder="Tên danh mục..." autoFocus />
              </div>
        ...
        <div className="fixed inset-0 z-[200] flex items-center justify-center bg-gray-900/60 backdrop-blur-sm p-4">
          <div className="bg-white w-full max-w-sm rounded-2xl shadow-2xl overflow-hidden">
            <div className="px-6 py-4 border-b flex justify-between items-center bg-gray-50">
              ...
              <button onClick={() => setIsAddSupplierOpen(false)} className="text-2xl cursor-pointer hover:text-red-500 leading-none">&times;</button>
            </div>
            <form onSubmit={handleQuickSaveSupplier}>
              <div className="p-6">
                <input type="text" value={newSupplierName} onChange={(e) => setNewSupplierName(e.target.value)}
                  className="w-full p-3 border rounded-xl outline-none focus:border-blue-500 font-medium" placeholder="Tên nhà cung cấp..." autoFocus />
              </div>
              <div className="px-6 py-4 bg-gray-50 flex gap-3">
