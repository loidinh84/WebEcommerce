  ...
  return (
    <div className="bg-[#F3F4F6] min-h-screen flex flex-col font-sans"> 
      ...
      <main className="flex-grow flex flex-col items-center justify-end p-4 pt-12 pb-8">
        {/* Tăng chiều rộng lên 600px và padding lên 12 */}
        <div className="max-w-[600px] w-full bg-white shadow-sm border border-gray-100 p-12">
          
          {/* Tiêu đề to hơn: text-3xl, margin-bottom 10 */}
          ...
          <form className="space-y-7">
            <div>
              <label className="block text-base font-semibold text-gray-700 mb-2">
                Email / Số điện thoại<span className="text-red-500 ml-1">*</span>
              </label>
              <input
                type="text"
            ...
            {/* Phần Duy trì đăng nhập & Quên mật khẩu to rõ hơn */}
            <div className="flex items-center justify-between pt-1">
              ...
              <a href="#" className="text-base text-blue-600 hover:text-blue-800 hover:underline italic font-medium transition-colors">
                Quên mật khẩu?
              </a>
            </div>
          ...
          {/* Form Google cũng to theo tỷ lệ */}
          <div className="mt-8">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-white text-gray-500 text-base">Hoặc đăng nhập bằng</span>
              </div>
            </div>
