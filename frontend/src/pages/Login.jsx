...
const Login = () => {
  ...
  const handleFacebookLogin = () => {
    ...
    const processFbLogin = async (accessToken) => {
      setLoading(true);
      try {
        const res = await fetch(`${BASE_URL}/api/taikhoan/facebook`, {
          method: "POST",
          headers: { "Content-Type": "application/json" },
    ...
    // Callback phải là function thường, không phải async
    window.FB.login(
      (response) => {
          ...
          <div className="mt-8">
            ...
            <div className="mt-8 flex flex-col gap-3">
              ...
              <button
                ...
                disabled={loading}
                className="w-full flex items-center justify-center gap-3 bg-[#1877F2] text-white font-bold py-3.5 px-4 hover:bg-[#1560c0] transition duration-200 text-base shadow-sm uppercase"
              >
